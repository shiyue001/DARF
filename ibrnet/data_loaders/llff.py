...
class LLFFDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # random_index = np.random.choice(np.arange(len(nearest_pose_ids)), size= min(num_select, len(nearest_pose_ids)), replace=False) 
        # nearest_pose_ids = nearest_pose_ids[random_index]
