...
from ibrnet.feature_network import MSBasicVSRPlusPlus
from ibrnet.feature_network import FFCResNetGenerator
...
class IBRNetModel(object):
    def __init__(self, args, load_opt=True, load_scheduler=True):
        ...
        if not args.use_ffc:
            ...
            # create feature extraction network
            self.feature_net = FFCResNetGenerator(input_nc=3, 
                                                    output_nc=64, 
                                                    ngf=64, 
                                                    n_downsampling=3,
                                                    n_upsampling=1,
        ...
        # create feature extraction network
        # self.feature_net = MSBasicVSRPlusPlus(mid_channels=64, num_blocks=7, max_residue_magnitude=10,
        #                 is_low_res_input=True, cpu_cache_length=100, scale_factor=4).cuda()
