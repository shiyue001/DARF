...
class RaySamplerSingleImage(object):
    def __init__(self, data, device, resize_factor=1, render_stride=1):
        ...
        if self.rgb is not None:
            ...
            self.depth_range = self.depth_range.reshape(-1, 1) #TODO
    ...
    def get_all(self):
        self.depth_range = self.depth_range.reshape(300, 400, 1) #TODO
        self.depth_range = self.depth_range[::self.render_stride, ::self.render_stride]   #TODO
        self.depth_range = self.depth_range.reshape(-1, 1)    #TODO
    ...
    def random_sample(self, N_rand, sample_mode, center_ratio=0.8):
        ...
        if self.rgb is not None:
            ...
            self.depth_range = self.depth_range[select_inds]     #TODO
        else:
            rgb = None
