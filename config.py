...
def config_parser():
    ...
    parser.add_argument('--outdir', type=str,
                        default='./results/',
                        help='the path to the project output directory. Replace this path with yours!')
    ...
    parser.add_argument('--num_source_views', type=int, default=5,
    ...
    parser.add_argument('--use_ffc', action='store_true', help='use FFC network or not')  #TODO
    parser.add_argument('--use_attn', action='store_true', help='use attention or not')  #TODO
